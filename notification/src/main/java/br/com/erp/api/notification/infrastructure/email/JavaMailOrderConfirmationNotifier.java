...
public class JavaMailOrderConfirmationNotifier implements OrderConfirmationNotifier {
    ...
    public JavaMailOrderConfirmationNotifier(JavaMailSender mailSender,
     ...
     */
    @Override
    public void notify(Order order, Customer customer,
