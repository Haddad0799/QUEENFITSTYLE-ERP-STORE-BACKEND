    ...
    public void replaceProduct(ProductSnapshot snapshot) {
        jdbi.useTransaction(handle -> {
            ...
            """)
                    ...
                    .bind("defaultSkuCode", snapshot.showcaseSelection() != null ? snapshot.showcaseSelection().skuCode() : null)
                    .bind("defaultSelectionLabel", snapshot.showcaseSelection() != null ? snapshot.showcaseSelection().label() : null)
